  ...
  return (
    <div className="p-4 h-[300px] md:h-[450px] overflow-auto  px-4 md:px-8 grid w-full gap-8 lg:grid-cols-custom_5">
      <div className="w-full flex flex-col gap-6 pt-3">
        ...
        {
          reservation ? <div className="w-full flex flex-col gap-4">
            ...
            <div className="w-full pt-2 flex flex-col gap-3">
              ...
              <div className="w-full flex items-center gap-4">
                ...
                <span className="text-base  font-semibold">{reservation?.roomid}</span>
              </div>

              <div className="w-full flex items-center gap-4">
                <span className="text-base  font-normal">Reservation Id:</span>
                <span className="text-base  font-semibold">{reservation?.id}</span>
              </div>
            </div>
          </div> : <div className="w-full flex flex-col gap-3">
            <div className="flex flex-col gap-2 w-full">
              <span className="font-bold text-sm"> Guest:</span>
              <UserListSelection handleUserSelection={handleUserSelection} />
            </div>
            <div className="w-full flex flex-col gap-2">
              <span className='font-bold text-sm'>Register New Guest</span>
              <span className="block text-xs text-gray"> To confirm registration of your new guest, please ensure that Guest is deselected or set to Null Guest.</span>
           ...
           font-normal text-[#333] text-sm flex items-center justify-between">
                  ...
                  <span><BiChevronDown fontSize={'17px'} /></span>
                </span>
